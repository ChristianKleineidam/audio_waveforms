...
// in audio_waveforms/test/desktop_audio_handler_test.dart.
...
import 'package:audio_session/audio_session.dart' as _i8;
...
class MockAudioPlayer extends _i1.Mock implements _i3.AudioPlayer {
  ...
  @override
  _i5.Stream<_i3.PlayerEvent> get playerEventStream => (super.noSuchMethod(
  ...
  @override
  _i5.Stream<_i3.PlayerException> get errorStream => (super.noSuchMethod(
  ...
  @override
  _i5.Future<void> removeAudioSourceAt(int? index) => (super.noSuchMethod(
        Invocation.method(
          #removeAudioSourceAt,
          [index],
        ),
  ...
  @override
  _i5.Future<void> removeAudioSourceRange(
    int? start,
    int? end,
  ) =>
      (super.noSuchMethod(
  ...
  @override
  _i5.Future<void> moveAudioSource(
    int? currentIndex,
    int? newIndex,
  ) =>
      (super.noSuchMethod(
  ...
  @override
  _i5.Future<void> clearAudioSources() => (super.noSuchMethod(
        Invocation.method(
          #clearAudioSources,
          [],
        ),
  ...
  _i5.Future<void> setAndroidAudioAttributes(
          _i8.AndroidAudioAttributes? audioAttributes) =>
      (super.noSuchMethod(
        Invocation.method(
  ...
  @override
  _i5.Future<void> setWebSinkId(String? webSinkId) => (super.noSuchMethod(
        Invocation.method(
          #setWebSinkId,
          [webSinkId],
        ),
